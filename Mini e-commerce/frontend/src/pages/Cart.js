...
function placeOrderHandler(){
    ...
    <div class="row d-flex justify-content-between">
        <div class="col-12 col-lg-8">
                ...
                {cartItems.map((item) =>
            (<Fragment> {/*useed again again used*/}
            ...
            <div class="cart-item">
                <div class="row">
                    ...
                    <div class="col-4 col-lg-1 mt-4 mt-lg-0">
                        <i id="delete_cart_item" onClick={()=>removeItemFromCart(item)} class="fa fa-trash btn btn-danger"></i>
                    </div>
        ...
        <div class="col-12 col-lg-3 my-4">
            ...
            :<Fragment>
                <h2 className='mt-5'> Order Copmlete!</h2> <p>Your order has been placed successfully!</p>
                </Fragment>)
}
